...
class ECDFPlotter(Plotter):
    ...
    def _plot_data(self, data: pd.DataFrame, param: Param, xlabel: str, ylabel: str, suffix: str = ""):
        ...
        for i, mode in enumerate(modes):
            ...
            ax.plot(series, range(1, len(series) + 1), linewidth=self.LINEWIDTH, color=color, label=label,
                    linestyle=ls)
        ...
        outfile = os.path.join(self.output_dir, "{}_ecdf{}{}.pdf".format(param, self.filename, suffix))
